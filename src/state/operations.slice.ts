...
export type OperationKind =
    ...
    | 'createMultisigGroup'
    | 'acceptMultisigInception'
    | 'authorizeMultisigAgent'
    | 'approveMultisigEndRole'
    | 'interactMultisigGroup'
    | 'acceptMultisigInteraction'
    | 'rotateMultisigGroup'
    | 'acceptMultisigRotation'
    | 'joinMultisigRotation'
    | 'approveDelegation'
    | 'generateOobi'
    | 'generateChallenge'
